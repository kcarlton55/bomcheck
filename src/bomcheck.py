...
def gatherBOMs_from_fnames(filename):
    ...
    try:
        ...
        print('Error reading clipbard: ' + str(e))   
...
def view_help(help_type='bomcheck_help', version='master', dbdic=None):
    ...
    remotePrefix = ('https://htmlpreview.github.io/?https://github.com/'
             'kcarlton55/bomcheck/blob/' + version + '/help_files/')
    #localPrefix = ('C:\\Users\\Ken\\Documents\\shared\\projects\\bomcheck\\help_files\\')
    prefix = remotePrefix
    
    d = {'bomcheck_help':          prefix + 'bomcheck_help_section1.html',
         'bomcheckgui_help':       prefix + 'bomcheckgui_help.html',
         'bomcheck_troubleshoot':  prefix + 'bomcheck_troubleshoot.html',
         'slowmoving_help':        prefix + 'slowmoving_help_section1.html', 
